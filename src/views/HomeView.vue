<template>
  ...
  <section class="container mx-auto">
    <div class="bg-white rounded border border-gray-200 relative flex flex-col">
      ...
      >
        <!-- v-icon.right.yellow:full="'headphone-alt'" 
        This would use the right and yellow modifiers and the 'full' argument for the directive. The value to be used inside the directive would be in the doublequotes
      -->
...
export default {
  ...
  /**
   * calling beforeUnmounted because we want to remove the events before component is just about to be unmounted
   *  If we use unmounted hook, it will cause errors because component is gone
   */
  beforeUnmount() {
